...
namespace MultiStation {
    ...
    uint32_t GetOpenGLInternalTextureFormat(TextureInternalFormat  format){
        ...
        switch (format){
            ...
            default:
                MS_ASSERT(0 , "Undefined Internal Texture Format Type !!!");
        }
        return 0;
    }
    ...
    uint32_t GetOpenGLDepthFormat(DepthFormat format){
        switch(format){
            ...
            default:
                MS_ASSERT(0 , "Undefind Depth Foramt Type !!!");
                return 0;
        }
        return 0;
    }
    ...
    uint32_t GetOpenGLFilter(Filter filter){
        switch (filter){
            ...
            default:
                MS_ASSERT(0 , "Undefined Filter Type !!!");
                return 0;
        }
        return 0;
    }
    ...
    uint32_t SizeOfShaderDataType(ShaderDataType type){
        switch(type){
            ...
            default : MS_ASSERT(0 , "Undefined Shader Data Type !!!"); return 0;
        }
        return 0;
    }
    ...
    ShaderDataType OpenGLDataTypeToShaderDataType(uint32_t oglType){
        switch(oglType){
            ...
            default : MS_ASSERT(0 , "Undefined Shader Data Type !!!"); return ShaderDataType::NONE;
        }
    ...
    uint32_t OpenGLAttributeDataTypeFromShaderDataType(ShaderDataType type    ){
        switch(type){
            ...
            default : MS_ASSERT(0 , "Undefined Attribute Data Type !!!"); return 0;
        }
        return 0;
    }
}